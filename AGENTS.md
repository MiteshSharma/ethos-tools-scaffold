...
<!-- Replace with your tool's description -->
A standalone npm package providing tools. Read `CLAUDE.md` before writing any code.

## Mandatory first reads

Before writing any code, read:
1. `CLAUDE.md` — conventions, commands, and gotchas
